    ...
    <header class="header" id="home">
        <div class="container">
            <div class="infos">
                ...
                <p class = "autotyping">And I am a <span class = "typing_text"></span></p>
        ...
        <tbody>
            <tr>
                ...
                <div class="buttons pt-3">
                    ...
                    <button class="btn btn-dark rounded">DOWNLOAD CV</button><br><br>
...
<div class="row container-fluid">
  @foreach($Cat as $key)
    <div class = "col-lg-6 col-md-6 col-sm-12 mt-3">
         <div class="card" >
         <img class="card-img-top" src="{{$key->CatImg}}" alt="Card image" style="width:100%">
            <div class="card-body">
            <h4 class="card-title">{{$key->cat_Name}}</h4>
            <p class="card-text">{{$key->cat_Desc}}</p>
            <a href="{{route('catProd',$key->Cid)}}" class="btn btn-primary">See Collection</a>
            </div>
          </div>
    </div>
    @endforeach
            ...
            <div class="contact text-left">
                <div class="form">
                    ...
                    <form action ="{{route('contact')}}" method = "post">
                        ...
                        <div class="form-group">
                            <textarea name="des" id="" cols="30" rows="5" class="form-control" placeholder="Message"></textarea>
                        </div>
...
//typing text animation script
    var typed = new Typed(".typing_text", {
        strings: ["UI/UX Designer", "Developer", "Blogger", "Designer", "Freelancer"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true,
        cursorChar: '|️',
